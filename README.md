<div align="center">
  ...
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=24&duration=1800&pause=700&color=0A66C2&center=true&vCenter=true&width=720&lines=%20;Backend+Developer;Cloud+%26+DevOps+Engineer;Laravel+%7C+Docker+%7C+Nginx+%7C+Cloud" alt="Animated typing intro" />
...
```mermaid
graph LR
    A[Laravel App] -->|Commit| B(GitHub Actions)
    B -->|Build & Test| C{Docker Image}
    C -->|Deploy| D[Cloud Server]
    D -->|Serve| E[Nginx / Cloudflare]
    
    style A fill:#FF2D20,stroke:#none,color:#fff
    style B fill:#2088FF,stroke:#none,color:#fff
    style C fill:#2496ED,stroke:#none,color:#fff
